...
function writeTeachersToDoc(teachers) {
  ...
  leaders.setAttribute("id", "leaders");
  document.getElementById("teacher_of_the_week").appendChild(leaders);
